...
-   Resolve configuration from the injected app instead of the helper ([#168](https://github.com/spatie/laravel-ignition/pull/168))
...
-   added solution for running Laravel Dusk in production ([#121](https://github.com/spatie/laravel-ignition/pull/121))
-   Automatically fix blade variable typos and optional variables ([#38](https://github.com/spatie/laravel-ignition/pull/38))
...
-   Add the ability to define a query collector max value ([#153](https://github.com/spatie/laravel-ignition/pull/153))

## 1.6.10 - 2019-09-18

-   fix `__invoke` method name in solution ([#151](https://github.com/spatie/laravel-ignition/pull/151))

## 1.6.9 - 2019-09-18

-   Add noscript trace information - fixes [#146](https://github.com/spatie/laravel-ignition/issues/146)

## 1.6.8 - 2019-09-18

-   Use javascript content type for asset response - fixes [#149](https://github.com/spatie/laravel-ignition/issues/149)

## 1.6.7 - 2019-09-18

-   Load javascript assets via URL. Fixes [#16](https://github.com/spatie/laravel-ignition/issues/16)
...
-   Ignore invalid characters in JSON encoding. Fixes [#138](https://github.com/spatie/laravel-ignition/issues/138)
...
-   Resolve configuration from the injected application instead of the helper - Fixes [#131](https://github.com/spatie/laravel-ignition/issues/131)

## 1.6.0 - 2019-09-09

-   add `RouteNotDefined` solution provider ([#113](https://github.com/spatie/laravel-ignition/pull/113))

## 1.5.0 - 2019-09-09

-   suggest running migrations when a column is missing ([#83](https://github.com/spatie/laravel-ignition/pull/83))

## 1.4.19 - 2019-09-09

-   Remove quotation from git commit url ([#89](https://github.com/spatie/laravel-ignition/pull/89))

## 1.4.18 - 2019-09-09

-   Fix open_basedir restriction when looking up config file. Fixes ([#120](https://github.com/spatie/laravel-ignition/pull/120))

## 1.4.17 - 2019-09-06

-   Remove Inter, Operator from font stack. Fixes [#74](https://github.com/spatie/laravel-ignition/issues/74)

## 1.4.15 - 2019-09-05

-   Use previous exception trace for view exceptions. Fixes [#107](https://github.com/spatie/laravel-ignition/issues/107)
...
-   Use a middleware to protect ignition routes ([#93](https://github.com/spatie/laravel-ignition/pull/93))
...
-   pass an empty string to query if no connection name is available - fixes [#86](https://github.com/spatie/laravel-ignition/issues/86)
...
-   Fixed context tab crash when not using git ([#24](https://github.com/spatie/laravel-ignition/issues/24))
...
-   add support for L5.5 & 5.6 ([#21](https://github.com/spatie/laravel-ignition/pull/21))
