...
namespace Spatie\LaravelIgnition\Tests\ContextProviders;
...
class LaravelLivewireRequestContextProviderTest extends TestCase
{
    ...
    protected function createRequestContext(array $fingerprint, array $updates = [], array $serverMemo = []): LaravelLivewireRequestContextProvider
    {
        ...
        return new LaravelLivewireRequestContextProvider($providedRequest, $this->livewireManager);
    }
}
